const searchHelper = (function fn() {
    ...
    function changePage(page) {
        footer = `
      <a href="javascript:searchHelper.prevPage()" id="btn_prev">Prev</a>
      <a href="javascript:searchHelper.nextPage()" id="btn_next">Next</a>
      page: <span id="page"></span>`;
        ...
        for (var i = (page - 1) * records_per_page; i < endlimit; i++) {
            output = `<div class="block"><div id="innerdiv"><iframe height =300 width=540 src="https://www.youtube.com/embed/${objJson[i].id.videoId}" class = "video"></iframe> </div>
